...
sourcesIndex["cfg_expr"] = {"name":"","dirs":[{"name":"expr","files":["lexer.rs","mod.rs","parser.rs"]},{"name":"targets","files":["list.rs","mod.rs"]}],"files":["error.rs","lib.rs"]};
...
sourcesIndex["guppy"] = {"name":"","dirs":[{"name":"graph","dirs":[{"name":"feature","files":["build.rs","cycles.rs","feature_list.rs","graph_impl.rs","mod.rs","proptest09.rs","query.rs","resolve.rs"]}],"files":["build.rs","build_targets.rs","cargo.rs","cycles.rs","graph_impl.rs","mod.rs","proptest09.rs","query.rs","query_core.rs","resolve.rs","resolve_core.rs"]},{"name":"petgraph_support","files":["dfs.rs","dot.rs","mod.rs","reversed.rs","scc.rs","walk.rs"]}],"files":["debug_ignore.rs","dependency_kind.rs","errors.rs","lib.rs","metadata_command.rs","package_id.rs","sorted_set.rs"]};
sourcesIndex["guppy_benchmarks"] = {"name":"","files":["lib.rs"]};
sourcesIndex["guppy_cmdlib"] = {"name":"","files":["lib.rs"]};
...
sourcesIndex["sized_chunks"] = {"name":"","dirs":[{"name":"inline_array","files":["iter.rs","mod.rs"]},{"name":"ring_buffer","files":["index.rs","iter.rs","mod.rs","slice.rs"]},{"name":"sized_chunk","files":["iter.rs","mod.rs"]},{"name":"sparse_chunk","files":["iter.rs","mod.rs"]}],"files":["lib.rs","types.rs"]};
...
sourcesIndex["target_spec"] = {"name":"","files":["evaluator.rs","lib.rs","parser.rs","platform.rs"]};
