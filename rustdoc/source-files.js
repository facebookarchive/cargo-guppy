...
sourcesIndex["hakari"] = {"name":"","dirs":[{"name":"cli_ops","files":["initialize.rs","manage_deps.rs","mod.rs","workspace_ops.rs"]},{"name":"explain","files":["display.rs","mod.rs","simplify.rs"]},{"name":"tabular","files":["column_spec.rs","error.rs","macros.rs","mod.rs","row.rs","table.rs","width_string.rs"]},{"name":"verify","files":["display.rs","mod.rs"]}],"files":["cargo_toml.rs","hakari.rs","helpers.rs","lib.rs","proptest_helpers.rs","summaries.rs","toml_out.rs"]};
