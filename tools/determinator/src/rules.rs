...
//!
//! If the `serde-1` feature is enabled, determinator rules can be read from a TOML file as well.
//!
...
///
/// If the feature `serde-1` is enabled, this forms a configuration file format that can be read
/// from a TOML file.
///
...
#[cfg_attr(feature = "serde-1", serde(deny_unknown_fields))]
pub struct DeterminatorRules {
    /// A list of rules that each changed file path is matched against.
    #[cfg_attr(feature = "serde-1", serde(default, rename = "path-rule"))]
    ...
    #[cfg_attr(feature = "serde-1", serde(default, rename = "package-rule"))]
...
impl DeterminatorRules {
    ...
    ///
    /// Requires the `serde-1` feature to be enabled.
    #[cfg(feature = "serde-1")]
...
pub struct PathRule {
    ...
    /// ```
    #[cfg_attr(feature = "serde-1", serde(with = "mark_changed_impl"))]
...
#[derive(Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde-1", derive(Deserialize, Serialize))]
#[cfg_attr(feature = "serde-1", serde(rename_all = "kebab-case", untagged))]
