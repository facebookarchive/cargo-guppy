...
pub struct Platform<'a> {
    // This is TargetInfo<'static> because:
    // * the only way to create one is to use a built-in triple, which returns 'static
    // * the triple() method returns a &'static str and not a &'a str.
    // TODO: consider changing this for the next breaking release
    target_info: &'a TargetInfo<'static>,
...
impl<'a> Platform<'a> {
    ...
    pub(crate) fn target_info(&self) -> &'a TargetInfo<'a> {
        self.target_info
    }
